  ...
  return (
    <>
      <header className='p-3 flex justify-between'>
        <MainTitle />
        <a href='mailto:sales.otterwave@gmail.com' className='transition duration-300 hover:underline pr-2 self-end'>Contactez-nous</a>
      </header>
      <div className="flex flex-col items-center justify-start gap-8 max-w-3xl text-center m-auto">
        ...
        <p className='max-w-lg m-auto'>Optimisez vos campagnes avec notre logiciel de marketing automation. Augmentez vos leads, améliorez la qualification et dynamisez vos campagnes grâce à nos experts. Gagnez du temps et rentabilisez votre temps.</p>
